...
def image_boxes(tag:str, tensor_image:Union[np.ndarray, torch.Tensor, str], tensor_boxes:Union[np.ndarray, torch.Tensor, str], rescale: int = ..., dataformats: str = ..., labels: Incomplete | None = ...): ...
def draw_boxes(disp_image:Union[torch.Tensor,np.ndarray], boxes:Union[torch.Tensor,np.ndarray], labels: Incomplete | None = ...)->np.ndarray: ...
def make_image(tensor:np.ndarray, rescale: int = ..., rois: Incomplete | None = ..., labels: Incomplete | None = ...)->Summary.Image: ...
